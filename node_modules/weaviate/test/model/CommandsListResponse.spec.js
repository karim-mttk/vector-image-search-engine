...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeaviateApi.CommandsListResponse();
  });
  ...
  describe('CommandsListResponse', function() {
    it('should create an instance of CommandsListResponse', function() {
      // uncomment below and update the code to test CommandsListResponse
      //var instane = new WeaviateApi.CommandsListResponse();
      //expect(instance).to.be.a(WeaviateApi.CommandsListResponse);
    });
