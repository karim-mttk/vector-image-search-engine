...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeaviateApi.Invitation();
  });
  ...
  describe('Invitation', function() {
    it('should create an instance of Invitation', function() {
      ...
      //var instane = new WeaviateApi.Invitation();
      //expect(instance).to.be.a(WeaviateApi.Invitation);
    });

    it('should have the property aclEntry (base name: "aclEntry")', function() {
