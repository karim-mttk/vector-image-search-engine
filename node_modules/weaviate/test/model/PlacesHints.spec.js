...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeaviateApi.PlacesHints();
  });
  ...
  describe('PlacesHints', function() {
    it('should create an instance of PlacesHints', function() {
      // uncomment below and update the code to test PlacesHints
      //var instane = new WeaviateApi.PlacesHints();
      //expect(instance).to.be.a(WeaviateApi.PlacesHints);
    });
