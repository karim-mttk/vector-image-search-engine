...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WeaviateApi.AdaptersActivateResponse();
  });
  ...
  describe('AdaptersActivateResponse', function() {
    it('should create an instance of AdaptersActivateResponse', function() {
      // uncomment below and update the code to test AdaptersActivateResponse
      //var instane = new WeaviateApi.AdaptersActivateResponse();
      //expect(instance).to.be.a(WeaviateApi.AdaptersActivateResponse);
    });
